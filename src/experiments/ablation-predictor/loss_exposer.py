...
def finetune(model_name, device, dataset_name, is_baseline=False, n_epochs=5, batch_size=4, output_dir=None):
    if dataset_name == 'e2e':
    ...
    training_args = TrainingArguments(
        output_dir= output_dir + "/" + model_name + output_dir_suffix,
...
if __name__ == '__main__':
    ...
    finetune(args.model_name, args.device, args.dataset, args.base, args.epochs, args.batch_size, args.output)
