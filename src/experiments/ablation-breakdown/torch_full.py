...
if __name__ == '__main__':
    ...
    with open(args.save_json, 'w') as f:
        json.dump(data, f)
    print('{{"test_case": "Full Parameter", "total_time": {:.3f}, "fwd_time": {:.3f}, "bwd_time": {:.3f}, "opt_time": {:.3f}, "predict_time": 0.000}}'.format(total_time, fwd_time, bwd_time, opt_time))
