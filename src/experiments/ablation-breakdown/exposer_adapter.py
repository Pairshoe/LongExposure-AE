...
from exposer.models.opt_exposer_adapter import OPTForCausalLM
from exposer.utils.config_utils import get_opt_exposer_adapter_config
...
if __name__ == '__main__':
    ...
    config = get_opt_exposer_adapter_config(args.model_name, 
    ...
    with open(args.save_json,'r') as f:
        data = json.load(f)
    data.append({"test_case": "Long Exposure+Adapter", "total_time": total_time, "fwd_time": fwd_time, "bwd_time": bwd_time, "opt_time": opt_time, "predict_time": predict_time})   
    
    with open(args.save_json, 'w') as f:
        json.dump(data, f)
        
    print('{{"test_case": "Long Exposure+Adapter", "total_time": {:.3f}, "fwd_time": {:.3f}, "bwd_time": {:.3f}, "opt_time": {:.3f}, "predict_time": {:.3f}}}'.format(total_time, fwd_time, bwd_time, opt_time, predict_time))
