...
if __name__ == '__main__':
    ...
    # Assume MLP is sparsely activated
    config.ffn_dim = int(0.75 * config.ffn_dim)
        ...
        try:
            ...
            for record in data_re:
                if record["Seq_len"] == seq_len:
                    record["Long Exposure+LoRA (optimal)"] = max_memory / 1024 ** 3
                    break
            print('{{"test_case": "Long Exposure+LoRA (optimal)", "max_memory_{}": {}}}'.format(seq_len, max_memory / 1024 ** 3))
